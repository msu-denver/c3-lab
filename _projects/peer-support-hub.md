---
title: Peer Support Hub
tagline: A unified platform for transparent, equitable, and coordinated peer support at MSU Denver
funding: MSU Denver
pi: Dr. Daniel Pittman
copi: Dr. Ranjidha Rajan
period: Spring 2026 - Fall 2026
---

## About the Project

The Peer Support Hub is a unified digital platform that streamlines how faculty at MSU Denver request and manage peer support resources across the [Supplemental Instruction (SI)](https://www.msudenver.edu/student-academic-services/supplemental-instruction/), [Teaching Assistant (TA)](https://www.msudenver.edu/student-academic-services/teaching-assistant-program/), and [Learning Assistant (LA)](https://www.msudenver.edu/learning-assistant-program/) programs. By consolidating three separate application processes into a single system, the Hub simplifies participation for faculty while preserving the autonomy and distinct missions of each program.
...
- **Transparency** - Faculty, staff, and leadership can view consistent, timely information about peer support availability, deadlines, and awards. The platform provides clearer visibility into how support is distributed across departments and courses.

- **Equity** - By providing a unified application process and coordinated data insights, the Hub helps align peer support resources with student and course needs. Program staff can make more informed decisions that reduce unintentional duplication and broaden access.

- **Coordination** - The Hub streamlines faculty-facing processes without altering the mission or decision-making authority of SI, TA, or LA programs. Each program retains full control over its review process, timeline, and eligibility criteria.
...
Interested in contributing to the Peer Support Hub? Contact Dr. Daniel Pittman at [dpittma8@msudenver.edu](mailto:dpittma8@msudenver.edu) for information about student developer opportunities.
